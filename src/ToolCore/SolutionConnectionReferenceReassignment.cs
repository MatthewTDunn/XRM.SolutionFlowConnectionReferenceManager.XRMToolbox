...
namespace SolutionConnectionReferenceReassignment
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Solution Flow Connection Reference Manager"),
        ExportMetadata("Description", "Audit, govern and reassign Power Automate Flow connection references at scale."),
